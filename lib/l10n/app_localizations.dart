...
abstract class AppLocalizations {
  ...
  /// No description provided for @complaintCategories.
  ///
  /// In en, this message translates to:
  /// **'Complaint Categories'**
  String get complaintCategories;
  ...
  /// No description provided for @attachImagesOptional.
  ///
  /// In en, this message translates to:
  /// **'Attach Images (Optional)'**
  String get attachImagesOptional;
  ...
  /// No description provided for @reportThroughCallCenter.
  ///
  /// In en, this message translates to:
  /// **'or report through their call center'**
  String get reportThroughCallCenter;
  ...
  String get complaintStatusUpdated;
  ...
  /// No description provided for @thankYouForPatience.
  ///
  /// In en, this message translates to:
  /// **'Thank you for your patience'**
  String get thankYouForPatience;
  ...
  /// No description provided for @viewAllComplaints.
  ///
  /// In en, this message translates to:
  /// **'View All Complaints'**
